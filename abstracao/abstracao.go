...
func main() {
	...
	fmt.Printf("Removendo do inicio: %v, após remoção:\n%v\n", lista.RemoverInicio(), lista)

	fmt.Printf("Removendo do fim: %v, após remoção:\n%v\n", lista.RemoverFim(), lista)

	fmt.Printf("Removendo do indice 3: %v, após remoção:\n%v\n", lista.RemoverIndice(3), lista)

	fmt.Printf("Removendo do indice 0: %v, após remoção:\n%v\n", lista.RemoverIndice(0), lista)

	fmt.Printf("Removendo do ultimo indice: %v, após remoção:\n%v\n", lista.RemoverIndice(len(lista)-1), lista)
